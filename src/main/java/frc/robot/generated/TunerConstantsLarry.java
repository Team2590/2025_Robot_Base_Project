...
public class TunerConstantsLarry {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(.1).withKI(0).withKD(0).withKS(.11530).withKV(0.82629);

  // The closed-loop output type to use for the steer motors;
  // This affects the PID/FF gains for the steer motors
  private static final com.ctre.phoenix6.swerve.SwerveModuleConstants.ClosedLoopOutputType
      kSteerClosedLoopOutput =
          com.ctre.phoenix6.swerve.SwerveModuleConstants.ClosedLoopOutputType.Voltage;
  ...
  private static final com.ctre.phoenix6.swerve.SwerveModuleConstants.SteerFeedbackType
      kSteerFeedbackType =
          com.ctre.phoenix6.swerve.SwerveModuleConstants.SteerFeedbackType.FusedCANcoder;
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.0224609375);
