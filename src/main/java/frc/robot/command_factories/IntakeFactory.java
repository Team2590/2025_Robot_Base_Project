...
public class IntakeFactory {
  ...
  public static Command setIntakeCoralPosition() {
    return container.getIntake().setPosition(IntakeConstantsLeonidas.INTAKE_FACTORY_CORAL_POSITION).withName("Set Intake Coral Position");
  }
  ...
  public static Command setIntakeAlgaePosition() {
    return container.getIntake().setPosition(IntakeConstantsLeonidas.INTAKE_FACTORY_ALGAE_POSITION).withName("Set Intake Algae Position");
  }
  ...
  public static Command setHomePosition() {
    return container.getIntake().setPosition(IntakeConstantsLeonidas.INTAKE_FACTORY_HOME_POSITION).withName("Set Intake Home Position");
  }
  ...
  public static Command setHoldingAlgaePosition() {
    return container.getIntake().setPosition(IntakeConstantsLeonidas.INTAKE_FACTORY_HOLDING_ALGAE_POSITION).withName("Set Intake Home Position");
  }
}
