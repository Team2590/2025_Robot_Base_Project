...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    driveTalon =
        new TalonFX(constants.DriveMotorId, constantsWrapper.DrivetrainConstants.CANBusName);
    turnTalon =
    ...
    StickyFaultUtil.clearCancoderStickyFaults(cancoder, "Drive Cancoder");
    StickyFaultUtil.clearMotorStickyFaults(turnTalon, "Turn Drive Motor");
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        RobotContainer.constantsWrapper.odometryFrequency, drivePosition, turnPosition);
    BaseStatusSignal.setUpdateFrequencyForAll(
        50.0,
        driveVelocity,
        driveAppliedVolts,
