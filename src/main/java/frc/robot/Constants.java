...
public final class Constants {
  ...
  */
  ...
  public final class IntakeArmConstantsLeonidas {
    public static final double INTAKE_GROUND_CORAL_POS = 0;
    public static final double INTAKE_HANDOFF_POS = 0.018-.41;
    public static final double INTAKE_HOME_POS = .15-.41;
    ...
    public static final double INTAKE_OPERATIONAL_MIN_POS = -.5;
    public static final double INTAKE_OPERATIONAL_MAX_POS = .1;
  }
