...
public class PoseEstimator {
  ...
  private final PhotonRunnable photonEstimator_1 =
      new PhotonRunnable("FrontCamera", Constants.VisionConstants.RobotToCam_1);
  private final PhotonRunnable photonEstimator_2 =
      new PhotonRunnable("TheOtherCamera", Constants.VisionConstants.RobotToCam_1);
  private final Notifier photonNotifier_1 = new Notifier(photonEstimator_1);
  private final Notifier photonNotifier_2 = new Notifier(photonEstimator_2);
  ...
  public PoseEstimator(Matrix<N3, N1> stateStdDevs) {
    ...
    photonNotifier_1.setName("PhotonRunnable");
    photonNotifier_1.startPeriodic(0.02);
    photonNotifier_2.setName("PhotonRunnable");
    photonNotifier_2.startPeriodic(0.02);
  }
  ...
  public PhotonRunnable getPhotonRunnable(int num) {
    if (num == 1) {
      return photonEstimator_1;
    }
    return photonEstimator_2;
  }
}
