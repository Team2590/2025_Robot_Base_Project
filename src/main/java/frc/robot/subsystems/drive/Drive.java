...
public class Drive extends SubsystemBase {
  ...
  private LoggedTunableNumber drivekPAutoBuilder =
      new LoggedTunableNumber("drivekP AutoBuilder", 5);
  ...
  public Drive(
    ...
    AutoBuilder.configure(
        ...
        new PPHolonomicDriveController(
            new PIDConstants(drivekPAutoBuilder.get(), 0.0, 0.0),
            new PIDConstants(steerkPAutoBuilder.get(), 0.0, 0.0)),
        PP_CONFIG,
