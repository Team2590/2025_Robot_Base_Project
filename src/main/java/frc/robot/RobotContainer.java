...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    leftJoystick.trigger().and(leftJoystick.button(4).negate()).whileTrue(EndEffectorFactory.runEndEffectorOuttake());
    ...
    leftJoystick.button(4).and(rightJoystick.trigger()).whileTrue(GamePieceFactory.intakeAlgaeGround());
    rightJoystick.trigger().and(leftJoystick.button(4).negate()).whileTrue(GamePieceFactory.intakeCoralFeeder());
