...
public class Robot extends LoggedRobot {
  ...
  public void robotPeriodic() {
    ...
    Logger.recordOutput("Cal/RobotPose", new Pose2d());
    Logger.recordOutput(
        "Cal/ZeroedComponentPoses",
        new Pose3d[] {new Pose3d(), new Pose3d(), new Pose3d(), new Pose3d()});
    Logger.recordOutput(
        "Cal/FinalComponentPoses",
        new Pose3d[] {
          // new Pose3d(
          //     new Translation3d(-0.365, -0.435, 0.155),
          //     new Rotation3d(
          //         Radians.convertFrom(90, Degrees), 0, Radians.convertFrom(90, Degrees))),
          // new Pose3d(),
          // new Pose3d(
          //     new Translation3d(0.13, 0, 0.08),
          //     new Rotation3d(Radians.convertFrom(90, Degrees), 0, 0))
          // new Pose3d(),
          // new Pose3d(),
          // new Pose3d(new Translation3d(0, 0, -(Timer.getTimestamp() * 0.1)), new Rotation3d())
        });
  }
