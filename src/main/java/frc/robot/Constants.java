...
public final class Constants {
  ...
  public static final Pose2d ReefSideNorthWest =
      new Pose2d(new Translation2d(3.5, 5.585), Rotation2d.fromDegrees(302.125));
  public static final Pose2d ReefSideNorthEast =
      new Pose2d(new Translation2d(5.489, 5.595), Rotation2d.fromDegrees(237.089));
  public static final Pose2d ReefSideEast =
      new Pose2d(new Translation2d(6.397, 3.950), Rotation2d.fromDegrees(180));
  public static final Pose2d ReefSideSouthEast =
      new Pose2d(new Translation2d(5.438, 2.415), Rotation2d.fromDegrees(122.005));
  public static final Pose2d ReefSideSouthWest =
      new Pose2d(new Translation2d(3.520, 2.426), Rotation2d.fromDegrees(59.194));
  ...
  public static final Pose2d Processor =
      new Pose2d(new Translation2d(10.760, 7.023), Rotation2d.fromDegrees(90));
