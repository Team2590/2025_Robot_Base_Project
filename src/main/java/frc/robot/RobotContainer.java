...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    rightJoystick.button(3).onTrue(elevator.setPosition(4));
    rightJoystick.button(4).onTrue(elevator.setPosition(14));
    rightJoystick.button(5).onTrue(elevator.setPosition(24));
  }
