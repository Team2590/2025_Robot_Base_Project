...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // Commands for if the button is in the blue barge

    rightJoystick
        .trigger()
        .and(() -> Constants.blueBarge.contains(drive.getPose().getTranslation()))
        .whileTrue(Commands.runOnce(() -> System.out.println("in the blue barge")));
    rightJoystick
        .trigger()
        .and(() -> Constants.redBarge.contains(drive.getPose().getTranslation()))
        .whileTrue(Commands.runOnce(() -> System.out.println("in the red barge")));
  }
